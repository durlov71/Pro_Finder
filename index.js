const CLIENT_ID = '78c3447aa13dabca8c08'
const CLIENT_SECRET = 'b589dc770f1e676176dec357720fb5c7da634186'
...
document.querySelector('#search').addEventListener('submit', async(e) => {
    ...
    username = document.querySelector('#findByUsername').value = '';
})
...
function showProfile(profile) {
    document.querySelector('.profile').innerHTML = ` <img src="${profile.avatar_url}" alt="${profile.name}" />
